# Web Design Replication Task: Meridian Freight Index

You are given screenshots of a **7-page logistics-data website** at three viewport sizes
...
- HTML files: `home.html`, `rates.html`, `routes.html`, `analytics.html`, `pricing.html`, `methodology.html`, `contact.html`
...
- `reference_screenshots/rates-desktop.png` — rates page, desktop viewport
- `reference_screenshots/rates-tablet.png` — rates page, tablet viewport
- `reference_screenshots/rates-mobile.png` — rates page, mobile viewport
- `reference_screenshots/routes-desktop.png` — routes page, desktop viewport
- `reference_screenshots/routes-tablet.png` — routes page, tablet viewport
- `reference_screenshots/routes-mobile.png` — routes page, mobile viewport
- `reference_screenshots/analytics-desktop.png` — analytics page, desktop viewport
- `reference_screenshots/analytics-tablet.png` — analytics page, tablet viewport
- `reference_screenshots/analytics-mobile.png` — analytics page, mobile viewport
- `reference_screenshots/pricing-desktop.png` — pricing page, desktop viewport
- `reference_screenshots/pricing-tablet.png` — pricing page, tablet viewport
- `reference_screenshots/pricing-mobile.png` — pricing page, mobile viewport
- `reference_screenshots/methodology-desktop.png` — methodology page, desktop viewport
- `reference_screenshots/methodology-tablet.png` — methodology page, tablet viewport
- `reference_screenshots/methodology-mobile.png` — methodology page, mobile viewport
